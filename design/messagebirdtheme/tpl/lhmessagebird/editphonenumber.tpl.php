<h1><?php echo erTranslationClassLhTranslation::getInstance()->getTranslation('messagebird/module','Edit');?></h1>
...
<form action="<?php echo erLhcoreClassDesign::baseurl('messagebird/editphonenumber')?>/<?php echo $item->id?>" method="post" ng-non-bindable autocomplete="off">

    <?php include(erLhcoreClassDesign::designtpl('lhmessagebird/form/phonenumber.tpl.php'));?>
